...
from tensorforce.core.memories.modified_replay import PrioritizedReplayBuffer
from tensorforce.core.memories.modified_replay import ReplayBuffer
...
__all__ = ['memories', 'Memory', 'ReplayBuffer']
